            ...
            <div class="col-sm-3">
                <div class="form-check">
                    <input class="form-check-input" id="reding" type="checkbox"
                        <?php if (in_array("Reading", $arr)) echo "checked"; ?> name="hobbies[]" value="Reading">
            ...
            <div class="col-sm-3">
                <div class="form-check">
                    <input class="form-check-input" id="trave" type="checkbox"
                        <?php if (in_array("Traveling", $arr)) echo "checked"; ?> name="hobbies[]" value="Traveling">
            ...
            <div class="col-sm-3">
                <div class="form-check">
                    <input class="form-check-input" id="game" type="checkbox"
                        <?php if (in_array("Gaming", $arr)) echo "checked"; ?> name="hobbies[]" value="Gaming">
